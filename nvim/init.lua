...
--vim.o.runtimepath:append('/usr/bin/fzf')
--vim.o.rtp:append('/usr/bin/sk')
...
--vim.keymap.set('n', '<leader>z', ':FZF<cr>')
vim.keymap.set('n', '<leader>z', ':FZF<cr>')
vim.keymap.set('n', '<leader>x', ':SK<cr>')
...
vim.keymap.set('v', 'gV', '`[v`]') --not working TODO
-- quickly select text you just pasted
